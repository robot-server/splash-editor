...
`measure_ramps.py` 가 여덟 타일셋에 실제로 놓아 보고 방향까지 가린 것.

| 타일셋 | 합계 | 아래로 | 위로 | 왼쪽 | 오른쪽 |
| --- | ---: | ---: | ---: | ---: | ---: |
| badlands | 68 | 22 | 17 | 16 | 13 |
| space | 136 | 46 | 36 | 29 | 25 |
| installation | 2 | 0 | 0 | 1 | 1 |
| ashworld | 34 | 10 | 9 | 8 | 7 |
| jungle | 102 | 34 | 27 | 22 | 19 |
| desert | 166 | 50 | 49 | 36 | 31 |
| ice | 102 | 30 | 31 | 23 | 18 |
| twilight | 102 | 32 | 29 | 22 | 19 |
| **합계** | **712** | | | | |

> **Installation 은 좌우 두 개뿐이다.** "여덟 타일셋에 네 방향이 다
> 있다" 고 쓰면 틀린다. 설치물 타일셋은 고도가 없어 램프랄 것이 거의
> 없다.

> 앞서 합계를 **612** 로 적어 두었다. **더하기를 틀렸다** — 712 다.
> 적대적 검토에서 잡혔다.

두뎃 **갈래** 수와 헷갈리지 않는다. [doodads.md](doodads.md) 가 세는
"램프 갈래" 는 Desert 86 · Space 72 … 로 합이 369 인데, 그것은
**catalogue 항목 수**이고 위 표는 **방향까지 가려 실제로 쓸 수 있다고
확인한 것**이다. 자가 다르다.
